 ...
 *
 */
$drupal_hash_salt = 'Gb8Jov5KUI1BdXPQ8Mv4Hy0sbQ-m31sQ8weYra_EwZQ';
...
/**
 * Environment indicator settings (7.x-1.x).
 */
$conf['environment_indicator_color'] = 'red';
$conf['environment_indicator_enabled'] = TRUE;
$conf['environment_indicator_text'] = 'DEV - ASCM';


/**
 * Stage file proxy settings.
 */
$conf['stage_file_proxy_origin'] = 'http://ascm.org.au';
